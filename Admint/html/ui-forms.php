...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                ...
                <div class="card" style="width: 50%;">
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input menu"
                ...
                <div class="card" style="width: 50%;">
                  <div class="card-body" id="form_image">
                    <form method="dialog" class="upl">
                      ...
                      <label for="exampleInputEmail1" class="form-label">Show/Hide</label>
                      <select name="logo_opt" class="form-select" aria-label="Default select example">
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                      ...
                      <tbody>
                        <?php 
                          ...
                          <td class="border-bottom-0">
                            <img height="70" width="70" id="image" src="../assets/img_box/<?php echo $row[1]; ?>">
                          </td>
                          <td class="border-bottom-0">
                            <?php echo $row[2]; ?>
                          </td>
    ...
    <!-- sub menu  -->
    <div class="modal fade" id="sub_menu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="padding: 15px;">
            ...
            <div>
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Input sub menu"
                aria-describedby="emailHelp">
            </div>
            <div>
      ...
      $('#img_box').change(function () {
        ...
        $.ajax({
          ...
          success: function (data) {
            //work after success   
            $('#img_box').css({ "background-image": "url(../assets/img_box/" + data.name + ")" });
